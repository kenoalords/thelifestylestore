...
urlpatterns = [
    ...
    path('push/subscribe', PushNotificationSubcription.as_view()),
    path('push/send', FetchPushNotificationSubscriptions.as_view(), name="send_push_notification"),
