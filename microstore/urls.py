...
from mibandapp.views import CustomLoginView, CustomLogoutView, CustomRegisterationView, CustomPasswordResetView, CustomPasswordResetDoneView, CustomPasswordResetConfirmView, CustomPasswordResetCompleteView
